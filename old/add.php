...
if(isset($_POST['submit'])){
    ...
    $result = $userCtrl->addUser($_POST['name'], $_POST['email']);
...
<body style="display: flex; align-items: center; justify-content: center; min-height: 50vh;">
<div class="formbg-outer py-5 px-5">
    <div class="formbg">
